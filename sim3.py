...
# Potential mean outcome
L_1_po11 = 0.6 * L_0 + 0.4 * np.ones(n) + 0.3 * U_0 + np.random.normal(0, 1, n)
Y_po11 = 1.2 * L_0 + 0.8 * L_1_po11 + 0.5 * np.ones(n) + 0.7 * np.ones(n) + 0.3 * U_0 + np.random.normal(0, 1, n)
print(np.mean(Y_po11))
